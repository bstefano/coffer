...
class AttributesTable: NSObject, Table {
    ...
    func tableAttributeName(_ dataObjectAttributeName: String) -> String {
        return Attributes.jsonKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBObjectModel?, _ error: NSError?) -> Void) {
        ...
        objectMapper.load(Attributes.self, hashKey: AWSIdentityManager.default().identityId!, rangeKey: nil) { (response: AWSDynamoDBObjectModel?, error: Error?) in
    ...
    func scanWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        objectMapper.scan(Attributes.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as NSError?)
            })
        }
    ...
    func scanWithFilterDescription() -> String {
        let scanFilterValue = "demo-idAtribute-500000"
        return "Find all items with idAtribute < \(scanFilterValue)."
    }
    ...
    func scanWithFilterWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        scanExpression.filterExpression = "#idAtribute < :idAtribute"
        scanExpression.expressionAttributeNames = ["#idAtribute": "idAtribute" ,]
        scanExpression.expressionAttributeValues = [":idAtribute": "demo-idAtribute-500000" ,]
    ...
    func insertSampleDataWithCompletionHandler(_ completionHandler: @escaping (_ errors: [NSError]?) -> Void) {
        ...
        let itemForGet: Attributes! = Attributes()
        
        itemForGet._userId = AWSIdentityManager.default().identityId!
        itemForGet._idAtribute = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("idAtribute")
        itemForGet._nmAttribute = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmAttribute")
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: Attributes = Attributes()
            item._userId = AWSIdentityManager.default().identityId!
            item._idAtribute = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("idAtribute")
            item._nmAttribute = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmAttribute")
    ...
    func removeSampleDataWithCompletionHandler(_ completionHandler: @escaping ([NSError]?) -> Void) {
        ...
        objectMapper.query(Attributes.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            if let error = error as? NSError {
                DispatchQueue.main.async(execute: {
    ...
    func updateItem(_ item: AWSDynamoDBObjectModel, completionHandler: @escaping (_ error: NSError?) -> Void) {
        ...
        let itemToUpdate: Attributes = item as! Attributes
        
        itemToUpdate._idAtribute = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("idAtribute")
        itemToUpdate._nmAttribute = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmAttribute")
