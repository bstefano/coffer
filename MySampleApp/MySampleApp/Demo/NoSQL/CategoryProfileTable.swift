...
class CategoryProfileTable: NSObject, Table {
    ...
    func tableAttributeName(_ dataObjectAttributeName: String) -> String {
        return CategoryProfile.jsonKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBObjectModel?, _ error: NSError?) -> Void) {
        ...
        objectMapper.load(CategoryProfile.self, hashKey: AWSIdentityManager.default().identityId!, rangeKey: nil) { (response: AWSDynamoDBObjectModel?, error: Error?) in
    ...
    func scanWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        objectMapper.scan(CategoryProfile.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as NSError?)
            })
        }
    ...
    func scanWithFilterDescription() -> String {
        ...
        return "Find all items with idCategory < \(scanFilterValue)."
    }
    ...
    func scanWithFilterWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        scanExpression.filterExpression = "#idCategory < :idCategory"
        scanExpression.expressionAttributeNames = ["#idCategory": "idCategory" ,]
        scanExpression.expressionAttributeValues = [":idCategory": 1111500000 ,]
    ...
    func insertSampleDataWithCompletionHandler(_ completionHandler: @escaping (_ errors: [NSError]?) -> Void) {
        ...
        let itemForGet: CategoryProfile! = CategoryProfile()
        ...
        itemForGet._idProfile = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("idProfile")
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: CategoryProfile = CategoryProfile()
            item._userId = AWSIdentityManager.default().identityId!
            item._idCategory = NoSQLSampleDataGenerator.randomSampleNumber()
            item._idProfile = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("idProfile")
    ...
    func removeSampleDataWithCompletionHandler(_ completionHandler: @escaping ([NSError]?) -> Void) {
        ...
        objectMapper.query(CategoryProfile.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            if let error = error as? NSError {
                DispatchQueue.main.async(execute: {
    ...
    func updateItem(_ item: AWSDynamoDBObjectModel, completionHandler: @escaping (_ error: NSError?) -> Void) {
        ...
        let itemToUpdate: CategoryProfile = item as! CategoryProfile
        
        itemToUpdate._idCategory = NoSQLSampleDataGenerator.randomSampleNumber()
        itemToUpdate._idProfile = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("idProfile")
