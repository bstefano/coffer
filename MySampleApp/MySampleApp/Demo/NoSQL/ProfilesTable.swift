...
class ProfilesTable: NSObject, Table {
    ...
    func tableAttributeName(_ dataObjectAttributeName: String) -> String {
        return Profiles.jsonKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBObjectModel?, _ error: NSError?) -> Void) {
        ...
        objectMapper.load(Profiles.self, hashKey: AWSIdentityManager.default().identityId!, rangeKey: nil) { (response: AWSDynamoDBObjectModel?, error: Error?) in
    ...
    func scanWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        objectMapper.scan(Profiles.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as NSError?)
            })
        }
    ...
    func scanWithFilterDescription() -> String {
        ...
        return "Find all items with idProfile < \(scanFilterValue)."
    }
    ...
    func scanWithFilterWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        scanExpression.filterExpression = "#idProfile < :idProfile"
        scanExpression.expressionAttributeNames = ["#idProfile": "idProfile" ,]
        scanExpression.expressionAttributeValues = [":idProfile": 1111500000 ,]
    ...
    func insertSampleDataWithCompletionHandler(_ completionHandler: @escaping (_ errors: [NSError]?) -> Void) {
        ...
        let itemForGet: Profiles! = Profiles()
        ...
        itemForGet._nmProfile = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmProfile")
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: Profiles = Profiles()
            item._userId = AWSIdentityManager.default().identityId!
            item._idProfile = NoSQLSampleDataGenerator.randomSampleNumber()
            item._nmProfile = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmProfile")
    ...
    func removeSampleDataWithCompletionHandler(_ completionHandler: @escaping ([NSError]?) -> Void) {
        ...
        objectMapper.query(Profiles.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            if let error = error as? NSError {
                DispatchQueue.main.async(execute: {
    ...
    func updateItem(_ item: AWSDynamoDBObjectModel, completionHandler: @escaping (_ error: NSError?) -> Void) {
        ...
        let itemToUpdate: Profiles = item as! Profiles
        
        itemToUpdate._idProfile = NoSQLSampleDataGenerator.randomSampleNumber()
        itemToUpdate._nmProfile = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmProfile")
