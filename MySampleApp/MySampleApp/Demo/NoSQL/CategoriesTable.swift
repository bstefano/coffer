...
class CategoriesTable: NSObject, Table {
    ...
    func tableAttributeName(_ dataObjectAttributeName: String) -> String {
        return Categories.jsonKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBObjectModel?, _ error: NSError?) -> Void) {
        ...
        objectMapper.load(Categories.self, hashKey: AWSIdentityManager.default().identityId!, rangeKey: nil) { (response: AWSDynamoDBObjectModel?, error: Error?) in
    ...
    func scanWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        objectMapper.scan(Categories.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as NSError?)
            })
        }
    ...
    func insertSampleDataWithCompletionHandler(_ completionHandler: @escaping (_ errors: [NSError]?) -> Void) {
        ...
        let itemForGet: Categories! = Categories()
        ...
        itemForGet._nmCategory = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmCategory")
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: Categories = Categories()
            item._userId = AWSIdentityManager.default().identityId!
            item._idCategory = NoSQLSampleDataGenerator.randomSampleNumber()
            item._nmCategory = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmCategory")
    ...
    func removeSampleDataWithCompletionHandler(_ completionHandler: @escaping ([NSError]?) -> Void) {
        ...
        objectMapper.query(Categories.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            if let error = error as? NSError {
                DispatchQueue.main.async(execute: {
    ...
    func updateItem(_ item: AWSDynamoDBObjectModel, completionHandler: @escaping (_ error: NSError?) -> Void) {
        ...
        let itemToUpdate: Categories = item as! Categories
        
        itemToUpdate._idCategory = NoSQLSampleDataGenerator.randomSampleNumber()
        itemToUpdate._nmCategory = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("nmCategory")
